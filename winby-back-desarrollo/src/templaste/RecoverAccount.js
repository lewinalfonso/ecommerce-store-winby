module.exports = ({ username, code }) => {
    ...
    <p style="font-size: 16px; line-height: 1.2; word-break: break-word; text-align: center; mso-line-height-alt: 19px; margin: 0;"><span style="font-size: 16px;"><em><strong>RESTABLECIMIENTO DE CONTRASEÑA</strong></em></span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
    ...
    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Hola <strong>${ username }</strong>, Hemos recibido una solicitud para restablecer la contraseña de tu cuenta de Winby, tu código de verificación es:</span></p>
    ...
    <p style="text-align: center; line-height: 1.5; word-break: break-word; font-size: 16px; mso-line-height-alt: 24px; margin: 0;"><span style="font-size: 16px;">Gracias por ayudarnos a mantener tu cuenta segura. El equipo de Winby</span></p>
    </div>
    </div>
    <!--[if mso]></td></tr></table><![endif]-->
    <!--[if (!mso)&(!IE)]><!-->
