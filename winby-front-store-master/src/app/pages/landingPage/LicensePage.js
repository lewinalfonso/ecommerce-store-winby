...
import LicensePageV from '../../components/landingPage/LicensePageV'
...
export default connect(({ formContact, phoneContact }) => ({ formContact, phoneContact }), { postLandingFormContact, postLandingPhoneContact })(LicensePage)