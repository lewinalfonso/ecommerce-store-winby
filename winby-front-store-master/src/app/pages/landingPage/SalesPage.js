...
import SalesPageV from '../../components/landingPage/SalesPageV'
...
export default connect(({ formContact, phoneContact }) => ({ formContact, phoneContact }), { postLandingFormContact, postLandingPhoneContact })(SalesPage)